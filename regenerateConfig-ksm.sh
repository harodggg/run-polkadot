...
polkadot build-spec --chain polkadot-local --disable-default-bootnode |
...
sed 's/1e+18/1000000000000000000/g'  > ./config/polkadot-platdot.json

echo "build relay raw chainspec"
polkadot build-spec --chain ./config/polkadot-platdot.json --disable-default-bootnode --raw > ./config/kusama-platdot-test.json
